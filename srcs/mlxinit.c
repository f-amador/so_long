...
{
	img->bimg = 50;
	img->p2addr = mlx_xpm_file_to_image(img->mlx, "./sprites/player2.xpm",
			&(img->bimg), &(img->bimg));
	img->caddr = mlx_xpm_file_to_image(img->mlx, "./sprites/collective.xpm",
			&(img->bimg), &(img->bimg));
	img->eaddr = mlx_xpm_file_to_image(img->mlx, "./sprites/exit.xpm",
			&(img->bimg), &(img->bimg));
	img->faddr = mlx_xpm_file_to_image(img->mlx, "./sprites/floor.xpm",
			&(img->bimg), &(img->bimg));
	img->paddr = mlx_xpm_file_to_image(img->mlx, "./sprites/player.xpm",
			&(img->bimg), &(img->bimg));
	img->waddr = mlx_xpm_file_to_image(img->mlx, "./sprites/wall.xpm",
			&(img->bimg), &(img->bimg));
